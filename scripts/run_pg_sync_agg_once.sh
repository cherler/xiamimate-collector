...
export PG_SYNC_AGG_INCREMENTAL_DATE_DAYS="${PG_SYNC_AGG_INCREMENTAL_DATE_DAYS:-45}"
export PG_SYNC_AGG_MAX_AFFECTED_BUCKETS="${PG_SYNC_AGG_MAX_AFFECTED_BUCKETS:-90}"
export PG_SYNC_AGG_MONTH_PARTITION_DOMAINS="${PG_SYNC_AGG_MONTH_PARTITION_DOMAINS:-1}"
export PG_SYNC_AGG_USE_SUBSET_DUCKDB="${PG_SYNC_AGG_USE_SUBSET_DUCKDB:-true}"
