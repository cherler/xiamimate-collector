...
def build_parser() -> argparse.ArgumentParser:
    ...
    auto.add_argument("--enable-strategy-expansion", action="store_true", help="启用下一阶段自动扩张: L2/L3 shortlist + keyword 扩张")
    auto.add_argument("--strategy-pending-threshold", type=int, default=200, help="待采集池超过该阈值时跳过下一阶段扩张 (默认 200)")
    auto.add_argument("--strategy-category-limit", type=int, default=2, help="每轮最多扩张多少个 L2/L3 shortlist 类目 (默认 2)")
