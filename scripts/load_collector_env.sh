...
COLLECTOR_ENV_OVERRIDE_NAMES=(
    PG_SYNC_DUCKDB_PATH
    PG_SYNC_DUCKDB_SOURCE
    PG_SYNC_INCLUDE_HISTORY
    PG_SYNC_TABLES
    PG_SYNC_SKIP_TABLES
    PG_SYNC_REFRESH_SNAPSHOT
    PG_SYNC_DUCKDB_THREADS
    PG_SYNC_DUCKDB_MEMORY_LIMIT
    PG_SYNC_DUCKDB_READ_MODE
    PG_SYNC_PROGRESS_LOG_FETCH_BATCHES
    PG_SYNC_AGG_PARTITIONED
    PG_SYNC_AGG_MODE
    PG_SYNC_AGG_HISTORY_DAYS
    PG_SYNC_AGG_LOOKBACK_DAYS
    PG_SYNC_AGG_INITIAL_LOOKBACK_DAYS
    PG_SYNC_AGG_INCREMENTAL_DATE_DAYS
    PG_SYNC_AGG_MAX_AFFECTED_BUCKETS
    PG_SYNC_AGG_MONTH_PARTITION_DOMAINS
    PG_SYNC_AGG_USE_SUBSET_DUCKDB
    PG_SYNC_AGG_SUBSET_DIR
    PG_SYNC_AGG_DUCKDB_THREADS
    PG_SYNC_AGG_DUCKDB_MEMORY_LIMIT
    PG_SYNC_AGG_PROGRESS_LOG_FETCH_BATCHES
    ...
    THEME_FEATURE_SYNC_REFRESH_SNAPSHOT
)
